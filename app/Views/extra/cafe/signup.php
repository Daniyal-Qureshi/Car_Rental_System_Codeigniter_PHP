  ...
  <div class="main-bg">
    <div class="login-container text-c animated flipInX">
            ...
            <div class="container-content">
                <form class="margin-t" action="signup_controller/save" id="form" method="post">
                    <div class="form-group" >
                        <input type="text" class="form-control" placeholder="Full name" required="" form="form" name="Fullname">
                    </div>
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="*****" required="" form="form" name="password">
                    </div>
                    
                    
                    <button type="submit" class="form-button button-l margin-b" form="form">Create Account</button>
    
                    <p class="text-whitesmoke text-center"><small>Already have account?</small></p>
                    <a class="text-darkyellow" href="signin_controller"><small>Sign In</small></a>
                </form>
...
<div class="introSection">
		...
		<div class="row">
		<div class="col-lg-12">
		<h3>Sukkur IBA Cafe</h3>
		<h4>
        Providing cafe services to faculty and students with immediate delivery.
