            ...
            <div class="container-content">
                <form class="margin-t" action="signin_controller/validateData" id="form" method="post">
                    <div class="form-group" >
                        <input type="email" class="form-control" placeholder="Username" required="" form="form" name="email">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="*****" required=""  name="password" form="form">
                    </div>
